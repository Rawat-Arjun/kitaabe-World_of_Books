...
import 'package:kitaabe/common/user_data_row.dart';
import 'package:kitaabe/views/home/drawer/profile/edit_profile_view.dart';
  ...
  void loadProfile() async {
    ...
    if (user != null) {
      setState(() {
        ...
        textController.genderController.text = user.gender.toString();
